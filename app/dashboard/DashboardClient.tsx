    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="w-full px-4 sm:px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { label: "Saldo Atual", value: balance, color: balance >= 0 ? "text-emerald-400" : "text-red-400", bg: "from-emerald-500/10 to-transparent", icon: "💰" },
            { label: "Total Receitas", value: totalIncome, color: "text-emerald-400", bg: "from-emerald-500/10 to-transparent", icon: "📈" },
            { label: "Total Despesas", value: totalExpense, color: "text-red-400", bg: "from-red-500/10 to-transparent", icon: "📉" },
          ].map(card => (
            ...
            {categoryData.length === 0 ? (
              ...
              <ResponsiveContainer width="100%" height={260}>
                <BarChart data={categoryData} layout="vertical">
                  ...
                  <Tooltip contentStyle={tooltipStyle} />
                  <Bar dataKey="value" fill="#10b981" radius={[0, 6, 6, 0]} name="Valor" />
                </BarChart>
              </ResponsiveContainer>
            )}
          </div>
